...
def signup_command():
    ...
    def additional_info_window(username, password):
        ...
        def submit_additional_info():
            ...
            query = "INSERT INTO clients (username, address, phone_number, password) VALUES (%s, %s, %s, %s)"
            params = (username, address, phone_number, password)
    ...
    def open_cart_window():
        ...
        def buy_items_to_cart():
            for item in shopping_cart:
                ...
                try:
                    execute_query(query, params, fetchall=False)
                except Exception as e:
